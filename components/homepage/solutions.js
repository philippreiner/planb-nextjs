...
export default function Solutions({ children, background }) {
    return (
        <Box as="section" py={[4, 12, 24]} bgImage="url('/images/graphic_office.png')" bgColor="blackAlpha.700" bgBlendMode="darken" className={Styles.solutions}>
            <Main maxW="full">
                <SegmentHeading title="Unsere Kompetenzbereiche" />
                <Grid templateRows="" gap="5" templateColumns={["1fr", "1fr", "1fr 1fr", null, "1fr 1fr 1fr"]}>
                    ...
                    <Box position="relative" w="100%" h="100%" p={[4, null]} pb={[4, 4, "100%"]} bg="gray.900">
                        <Flex className={Styles.full} p={[4, 4, 6, 12]} alignItems="center">
                            <Box>
                                ...
                                <Text pb={[4, 8]} color="gray.100">Unser Ansatz für kompromisslose Sicherheit in der digitalen Welt.</Text>
                                <Arrowlink url="/cyber-security" label="Serviceleistungen entdecken" color="#FF5100" />
                            </Box>
                        </Flex>
                    </Box>
                </Grid>
