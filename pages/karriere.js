                ...
                <Main maxW="full">
                    <Box width="100%" pt={[12, 20, 32]} pb={[12, 20, 32]}>
                        ...
                        <Box display={["block", "block", "none", "none", "none"]}>
                            ...
                            <Box pt="12px"><Arrowlink color="#FF5100" target="_blank" label="Accountant" url="/documents/PlanB_Buchhaltung.pdf" width="100%" /></Box>
                        ...
                        <Box display={["none", "none", "block", "block", "block"]}>
                            ...
                            <Box pt="12px"><Arrowlink color="#FFF" target="_blank" label="Accountant" url="/documents/PlanB_Buchhaltung.pdf" width="100%" /></Box>
