            ...
            <GridItem pos="relative" colSpan={[1,null,5]}> {/*------------------------Rechte Hälfte (Eingabeformular)------------------------*/}
              ...
              <Grid templateColumns={["repeat(3, 1fr)"]}
                ...
                <GridItem pos="relative"> 
                  ...
                  <Input type="name" placeholder="Max Mustermann"/>
                  </FormControl>
                </GridItem>
                ...
                <GridItem pos="relative"> 
                  ...
                  <Input type="email" placeholder="max@adresse.com"/>
                  </FormControl>
                </GridItem>
                ...
                <GridItem pos="relative" colSpan={[1,null,3]}> 
                  ...
                  <Input type="betreff" placeholder="Bitte geben Sie einen Betreff ein..."/>
                  </FormControl>
                </GridItem>
                ...
                <GridItem pos="relative" colSpan={[1,null,3]} rowSpan={[1,null,2]} >
                  ...
                  <Input type="nachricht" h="185" placeholder="Bitte geben Sie eine Nachricht ein..."/>
                  </FormControl>
                </GridItem>
