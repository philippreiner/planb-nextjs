            ...
            <Hero background="url(images/cs-hero.jpeg)" backgroundSize={"cover"} backgroundPosition={"top left"} backgroundColor="#0097CE">
                <Main maxW="full">
                    <Box mt={[10, null, null]} pt={[12, 20, 32]} pb={[12, 20, 32]}>
                        ...
                        <Box w="100px" bg="white" h="6px" my="2" mb={[4, 6, 12]}></Box>

                        <Box pos="relative">
                            <Box pos="relative" maxW="full" pb="auto">
                            ...
                            <Box pos="relative" maxW="full" pb="auto">
                                <SegmentHeading opacity={1} title="Wie verstehen wir die aktuelle Situation…" />
                                <Text 
                                    pb={[2, 4, 12]}
                                    color="white">
                            ...
                            <Box pos="relative" maxW="full" pb="auto">
                                <SegmentHeading opacity={1} title="Wie gehen wir vor…" />
                                <Text 
                                    pb={[2, 4, 12]}
                                    color="white">
                                    ...
                                    Ziel ist ein ganzheitliches Konzept, welches alle modernen Aspekte berücksichtigt - organisatorisch und technologisch.
